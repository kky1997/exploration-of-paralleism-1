/*
   ...
   omp_nbody_basic.c program

   omp_nbody_basic solver program. The only modification to this program is the definition of macro NO_OUTPUT.
   ...
   collection text file (eg. runtimes from this basic nbody solver will be redirected into basic.txt).

   This basic nbody solver uses default partitioning (block partitioning) for all the omp for loops.
